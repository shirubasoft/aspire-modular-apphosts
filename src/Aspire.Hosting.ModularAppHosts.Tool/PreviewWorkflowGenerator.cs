...
internal static partial class PreviewTool
{
    ...
    private static string RenderProducerWorkflow(ProducerWorkflowOptions options)
    {
        ...
        builder.AppendLine("# Configure authentication with producer-owned scripts; regenerate after changing options.");
        ...
        builder.AppendLine("        uses: actions/checkout@v7");
        ...
        builder.AppendLine("        uses: actions/upload-artifact@v7");
        builder.AppendLine("        with:");
        builder.AppendLine("          name: module-preview");
