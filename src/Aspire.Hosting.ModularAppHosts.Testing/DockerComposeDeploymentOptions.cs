...
{
    /// <summary>Gets or sets the Aspire deployment environment name.</summary>
    public string EnvironmentName { get; set; } = DockerComposeDeploymentTestingBuilder.DefaultDeploymentEnvironmentName;
